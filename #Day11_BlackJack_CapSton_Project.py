...
def addition():
    sum_card=0
    for x in player_score:
        sum_card+=x
    return sum_card

total_player=addition()
print (f"{player_score} card fron deck and total is : {total_player}")
...
if cont_next=="H":
    while cont_next=="H":
        ...
        if next_total>21:
            print ("BUST")
            print (f"{player_score} card fron deck and total is : {next_total}")
            break
        else:
            cont_next = input ("Do you want to HIT of STAND: ").upper()
